export const framework = [
  ...
  {
    content: '针对 Vue3 的实用Hooks集合，V3Hooks也可以说是ahooks的Vue实现，绝大部分Api是保持一致的',
    avatar:
      'https://www.gitbook.com/cdn-cgi/image/width=40,dpr=2,height=40,fit=contain,format=auto/https%3A%2F%2F2023154663-files.gitbook.io%2F~%2Ffiles%2Fv0%2Fb%2Fgitbook-legacy-files%2Fo%2Fspaces%252F-Mdz9GM87dUs_cwFPZXR%252Favatar-1631092504616.png%3Fgeneration%3D1631092505100217%26alt%3Dmedia',
    title: 'Vue Use',
    github: 'https://yanzhandong868.gitbook.io/v3hooks/',
    color: 'bg-green-600',
    author: 'Vue3 Hooks集合',
  },
];
